                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" name="password" placeholder="Masukkan password untuk melindungi pelajaran" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
