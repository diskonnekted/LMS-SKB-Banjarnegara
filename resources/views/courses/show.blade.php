                            ...
                            <div class="border-t pt-8">
                                                ...
                                                <div class="flex justify-between items-start">
                                                    ...
                                                    @else
                                                        @if($module->lessons->count() > 0)
                                                            ...
                                                            @endphp
                                                            <a href="{{ route('learning.lesson', [$course, $module, $firstLesson]) }}" class="px-3 py-1 bg-white border border-gray-300 rounded text-sm text-gray-700 hover:bg-gray-50">
                                                                Mulai Modul
                                                            </a>
                                                        @endif
                                                    @endrole
                                ...
                                @else
                                    <div class="bg-gray-50 border border-dashed border-gray-300 rounded-lg p-8 text-center">
                                        <p class="text-gray-500 mb-4">Belum ada modul yang ditambahkan ke kursus ini.</p>
