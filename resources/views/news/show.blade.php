    ...
    <div class="pt-24 pb-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <a href="{{ route('home') }}#news" class="inline-flex items-center text-indigo-600 hover:text-indigo-700 font-medium mb-8 transition-colors">
            ...
            @if($news->thumbnail)
                <div class="relative rounded-3xl overflow-hidden shadow-2xl mb-12 aspect-video">
            ...
            <div class="mt-16 pt-8 border-t border-gray-100 flex justify-between items-center">
                ...
                <div class="flex space-x-4">
                    <button class="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
